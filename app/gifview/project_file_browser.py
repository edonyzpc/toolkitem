...
class GUI(object):
    ...
    def init_gui(self):
        ...
        #self.frame.grid(row=0, sticky=tkinter.N)
        ...
        self.labframe = tkinter.LabelFrame(self.frame, text="Animinate File",
                                            height=50, width=400, background="white")
        self.labframe.grid(row=0, column=0, sticky=tkinter.N)
        # listbox
        ...
        self.lsbox = tkinter.Listbox(self.labframe,
                                      height=50, width=200, selectmode=tkinter.BROWSE, background="yellow")
        self.lsbox.bind("<Double-Button-1>", selectpcfile)
